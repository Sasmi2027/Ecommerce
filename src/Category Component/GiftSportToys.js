...
import t1 from "../img/All category/Gift Sport Toys/51CcVFal-OL._SY450_.jpg";

function GiftSportToys({ addToCart }) {
  const [count, setCount] = useState([
    {
      img: t1,
      Cat: "all toys",
      name: "Cubelelo Drift",
      cont: "3M 3x3 (Magnetic) Stickerless Speed Cube | Brainteaser Stress Buster Brainstorming Puzzle",
      price: 499,
      MRP: 999,
      offer: "(50%)",
      orderedQ: 1,
    ...
    <>
      <div className="container">
        <div className="grid-2">
          ...
          <div className="df">{gst}</div>
        </div>
      </div>
    </>
  );
}
export default GiftSportToys;
